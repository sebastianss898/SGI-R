...
export const PERMISSIONS = {
  ...
  // Turnos
  VIEW_SHIFTS_SCHEDULE: 'view_shifts_schedule',
  EDIT_SHIFTS_SCHEDULE: 'edit_shifts_schedule',
  PUBLISH_SHIFTS_SCHEDULE: 'publish_shifts_schedule',
};
...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.MANAGER]: [
    ...
    PERMISSIONS.EDIT_SHIFTS_SCHEDULE,
    PERMISSIONS.PUBLISH_SHIFTS_SCHEDULE,
  ],
